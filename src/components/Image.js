...
export const Image = ({ imageData = {}, heading, ...props }) => {
  ...
  const headingAttrs = heading ? { style: { minHeight: "30vh", height: "100%", maxHeight: "28rem", minWidth: "100%" }, imgStyle: { objectPosition: "center top" }, className: "blur", loading: "eager" } : {}
